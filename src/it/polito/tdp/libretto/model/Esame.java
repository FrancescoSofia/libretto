...
/* Oggetto semplice che contiene i dati relativi ad ogni singolo esame
...
// private Docente docente; (più giusto).
...
/**
 * Se l'esame non è ancora stato superato,lo considera superato con il voto e la data specificati.
 * Se invece lesame era già superato, genera un'eccezione.
 * 
 * @param voto 
 * @param data
 */
